...
const Profile = () => {
  ...
  const [start_route, setStart_route] = useState(null);
  const [end_route, setEnd_route] = useState(null);
    ...
    AsyncStorage.getItem("conductorInfo")
      .then((value) => {
        if (value !== null) {
          ...
          setBusNo(userData.busNo);
          setStart_route(userData.start_route);
          setEnd_route(userData.end_route);
    ...
    >
      <View style={styles.container}>
        ...
        <View style={styles.userInfoContainer}>
          ...
          <Text style={styles.userInfoLabel}>Name: {conductorName} </Text>
          <Text style={styles.userInfoLabel}>User Name: {username}</Text>
          <Text style={styles.userInfoLabel}>Bus No: {busNo}</Text>
          <Text style={styles.userInfoLabel}>Bus Route: {start_route} - {end_route}</Text>
        </View>
